      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-shrink-0">
          <svg viewBox="0 0 200 200" className="w-48 h-48 mx-auto">
            ...
            <text x="100" y="95" textAnchor="middle" className="text-xs fill-gray-500">Total</text>
            <text x="100" y="112" textAnchor="middle" className="text-sm font-bold fill-gray-900">
